...
exports.GetAllHistoriesViewModel = void 0;
class GetAllHistoriesViewModel {
    historyUuid;
    tournamentId;
    tournamentName;
    gameType;
    ...
    static fromQueryDTOList(queryDTO) {
        return queryDTO.map(dto => new GetAllHistoriesViewModel(dto.historyUuid, dto.tournamentId, dto.tournamentName, dto.gameType, dto.player1Username, dto.player1Alias, dto.player1Points, dto.player2Username, dto.player2Alias, dto.player2Points, dto.player3Username, dto.player3Alias, dto.player3Points, dto.player4Username, dto.player4Alias, dto.player4Points));
    }
}
exports.GetAllHistoriesViewModel = GetAllHistoriesViewModel;
