...
export class TournamentController extends BaseController
{
    ...
    {
        const body = request.body;
        const editTournamentDTO: EditTournamentDTO = new EditTournamentDTO(body.torunamentUuid, body.tournamentName, body.player1Username, body.player2Username, body.player3Username, body.player4Username);
